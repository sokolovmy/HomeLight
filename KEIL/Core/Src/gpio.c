...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, IN_LOAD_Pin|IN_INHB_Pin|OUT_PUSH_DATA_Pin|LED_GREEN_Pin
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, EEPROM_CS_Pin|LED_ENABLE_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PAPin PAPin PAPin PAPin
                           PAPin PAPin PAPin */
  GPIO_InitStruct.Pin = IN_LOAD_Pin|IN_INHB_Pin|OUT_ENABLE_Pin|OUT_PUSH_DATA_Pin
